...
function ServiceList() {  
  ...
  return (
    ...
    <div className="Loading flex flex-col inset-0 fixed bg-teal-300 z-50 backdrop-blur-md bg-opacity-50">
        <div className="mx-auto my-auto">
            <div role="status" className="flex flex-col items-center">
              ...
              <p className="mx-auto w-1/2 text-center font-thin text-cyan-700">
              If you’re experiencing unusually long loading times, All servers in the resume are currently undergoing maintenance. Please be patient as we work to resolve this. If the issue persists, we apologize for the inconvenience and kindly request that you contact our developer, Muhammad Shibil, for further assistance.    </p>
    ...
    <div className="mx-12">
        ...
        <div className="div sm:mx-20 sm:w-5/6">
