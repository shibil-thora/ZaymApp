        ...
        <div className="max-w-6xl flex justify-between md:mx-auto mx-8 py-2 ">
            ...
            <div className="hidden md:block">
                <section className="flex justify-between space-x-8 mt-3 items-center">
                    ...
                    <h4 className="text-white hover:bg-black hover:bg-opacity-5 rounded-md hover:cursor-pointer px-2 ">About us</h4>
                  
                </section>
            </div> 
            <div className="flex">
              <div className="md:flex hidden hover:cursor-pointer w-8 h-8 shadow-lg bg-black bg-opacity-20 rounded-full hover:bg-orange-600 mt-2 justify-center">   
            ...
            <div className='w-12 h-12 hover:px-4 hover:py-4 hidden md:block hover:cursor-pointer shadow-lg rounded-full border-4 hover:border-4 hover:border-orange-600 md:mx-4 bg-white'></div>
            </div>
