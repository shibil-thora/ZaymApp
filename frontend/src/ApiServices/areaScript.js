...
for (const dist in stateDate.districts) {
    for (const subDist in stateDate.districts[dist].subDistricts) {
        for (const village in stateDate.districts[dist].subDistricts[subDist].villages){
            villages.push({
                state: stateDate.state, 
                dist: stateDate.districts[dist].district, 
                sub_dist: stateDate.districts[dist].subDistricts[subDist].subDistrict,
                village: stateDate.districts[dist].subDistricts[subDist].villages[village]
            })
